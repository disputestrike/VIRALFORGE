 ...
 * (Deepgram STT → configured LLM provider → telephony TTS). deepgramVoiceAgent.ts is not wired on the live WS path.
 *
...
export type VoiceTracePhase =
  ...
  | "barge_in_detected"
  | "tts_interrupted"
  | "interrupt_context_frozen"
  | "interrupt_decision"
  | "interrupt_continue_resume"
  | "interrupt_pivot_resume"
  | "web_interrupt_signal"
